<?php
/*
Plugin Name: VSC Demo Plugin - Hello Short Code
Text Identifier: vsc-demo-plugin
Custom Post Type: None
Plugin URI: 
Description: Create a short code to display 'Hello World!'
Version: 1.0
...
function vsc_plugin_initialise() {
	...
	//register_post_type( 'vsc-demo-plugin', $args );
